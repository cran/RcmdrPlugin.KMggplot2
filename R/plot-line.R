#' Line Chart Subclass
#'
#' \code{line} class is a subclass for line charts.
#'
...
#'
#' \code{windowScatter} function is a wrapper function of \code{line} class for the R-commander menu bar.
#'
#' @rdname plot-line-windowLine
#' @keywords hplot
#' @export
windowLine <- function() {
