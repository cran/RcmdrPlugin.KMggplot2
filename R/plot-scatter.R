...
#'
#' \code{scatter} class is a subclass for scatter plots.
#'
...
#'
#' \code{windowScatter} function is a wrapper function of \code{scatter} class for the R-commander menu bar.
#'
#' @rdname plot-scatter-windowScatter
#' @keywords hplot
#' @export
