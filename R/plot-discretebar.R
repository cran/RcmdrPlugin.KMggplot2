...
#'
#' \code{discretebar} class is a subclass for discrete bar charts.
#'
...
#' @family plot
#'
#' @name discretebar-class
#' @aliases discretebar
#' @rdname plot-discretebar
#' @docType class
#' @keywords hplot
#' @export discretebar
discretebar <- setRefClass(
...
#'
#' \code{windowDiscretebar} function is a wrapper function of \code{discretebar} class for the R-commander menu bar.
#'
#' @rdname plot-discretebar-windowDiscretebar
#' @keywords hplot
#' @export
windowDiscretebar <- function() {

  Discretebar <- discretebar$new()
