...
#'
#' \code{contour} class is a subclass for contour plots.
#'
...
#'
#' \code{windowContour} function is a wrapper function of \code{contour} class for the R-commander menu bar.
#'
#' @rdname plot-contour-windowContour
#' @keywords hplot
#' @export
