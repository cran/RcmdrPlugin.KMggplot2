#' Histogram Subclass
#'
#' \code{hist} class is a subclass for histograms.
#'
...
#'
#' \code{windowHist} function is a wrapper function of \code{hist} class for the R-commander menu bar.
#'
#' @rdname plot-hist-windowHist
#' @keywords hplot
#' @export
windowHist <- function() {
