#' Box Plot Subclass
#'
#' \code{box} class is a subclass for box plots.
#'
...
#'
#' \code{windowBox} function is a wrapper function of \code{box} class for the R-commander menu bar.
#'
#' @rdname plot-box-windowBox
#' @keywords hplot
#' @export
windowBox <- function() {
