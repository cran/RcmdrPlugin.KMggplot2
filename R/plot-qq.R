#' Q-Q Plot Subclass
#'
#' \code{qq} class is a subclass for Q-Q plots.
#'
...
#'
#' \code{windowQQ} function is a wrapper function of \code{qq} class for the R-commander menu bar.
#'
#' @rdname plot-qq-windowQQ
#' @keywords hplot
#' @export
windowQQ <- function() {
